...
import { loginToFirebase, logoutOfFirebase } from 'js/firebase.js'

import techlaunchLogo from 'images/techlaunch-whitebg.png'
...
class Menu extends Component {
    ...
    onCreatePostClick = () => {
        ...
        this.toggleMenu()
        this.context.router.history.push(PP + 'posts/new')
    }
        ...
        return (
            <div>
                ...
                <div className={(this.state.isMenuVisible) ? 'Menu visible' : 'Menu'}>
                    ...
                    <Link onClick={this.toggleMenu} to={`${PP}posts`} className="Menu-item">View All Posts</Link>
                    {userId &&
